...
public class AbsoluteURLFactory extends XWikiServletURLFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(AbsoluteURLFactory.class);
...
/*    public URL createSkinURL(String filename, boolean forceSkin, XWikiContext context) {
    ...
    private URL createSkinURLImpl(String filename, String skin, XWikiContext context) {
        ...
        String cdn = context.getWiki().Param("net.hoplahup.absoluteurlfactory.attachmentsBaseURL",null);
    ...
    public String getURL(java.net.URL url, XWikiContext context) {
    ...
    public URL createAttachmentURL(String filename, String web, String name, String action, String querystring,
        ...
        if("download".equals(action)) {
            try {
                ...
                String cdnBaseURL = context.getWiki().Param("net.hoplahup.absoluteurlfactory.attachmentsBaseURL");
                ...
                if(LOGGER.isDebugEnabled()) LOGGER.debug("createAttachmentURL: " + action + " " + web + " " + name + " " + filename + ": returning \"" + b + "\".");
